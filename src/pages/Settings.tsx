...
import { ArrowLeft, Bell, Moon, Shield, Smartphone, Globe, Info, Check, X } from "lucide-react";
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#1A2F4A] to-[#355074] px-4 py-4 flex items-center justify-between flex-shrink-0">
              <h3 className="text-white font-medium">개인정보 처리방침</h3>
            ...
            >
              <div className="space-y-4 text-sm leading-relaxed">
                <section>
                  <h4 className="font-semibold mb-2" style={{ color: textPrimary }}>1. 개인정보의 수집 및 이용 목적</h4>
                  <p>Damara는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</p>
                ...
                <section>
                  <h4 className="font-semibold mb-2" style={{ color: textPrimary }}>2. 수집하는 개인정보 항목</h4>
                ...
                <section>
                  <h4 className="font-semibold mb-2" style={{ color: textPrimary }}>3. 개인정보의 보유 및 이용기간</h4>
                  <p>회원 탈퇴 시까지 보유하며, 탈퇴 후에는 지체 없이 파기합니다. 단, 관계 법령에 따라 보존할 필요가 있는 경우 해당 기간 동안 보관합니다.</p>
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <section>
                  <h4 className="font-semibold mb-2" style={{ color: textPrimary }}>4. 개인정보의 제3자 제공</h4>
                  <p>Damara는 원칙적으로 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.</p>
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <section>
                  <h4 className="font-semibold mb-2" style={{ color: textPrimary }}>5. 이용자의 권리와 그 행사방법</h4>
                  <p>이용자는 언제든지 자신의 개인정보를 조회하거나 수정할 수 있으며, 회원 탈퇴를 통해 개인정보 처리 정지를 요청할 수 있습니다.</p>
                </section>

                <section>
                  <h4 className="font-semibold mb-2" style={{ color: textPrimary }}>6. 개인정보 보호책임자</h4>
                  <p>개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
                  <div className="mt-2 p-3 rounded-lg" style={{ backgroundColor: bgIcon }}>
                ...
                <section>
                  <h4 className="font-semibold mb-2" style={{ color: textPrimary }}>7. 개인정보 처리방침 변경</h4>
                  <p>이 개인정보 처리방침은 2025년 11월 29일부터 적용됩니다. 변경사항이 있을 경우 앱 내 공지사항을 통해 안내드립니다.</p>
                </section>
              </div>
            </div>
            ...
            >
              <button
                ...
                className="w-full py-3 rounded-xl text-white font-medium bg-gradient-to-r from-[#1A2F4A] to-[#355074]"
              >
                확인
              </button>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#1A2F4A] to-[#355074] px-4 py-4 flex items-center justify-between">
              <h3 className="text-white font-medium">글꼴 크기</h3>
            ...
            <div className="p-2">
              {(["small", "medium", "large"] as FontSize[]).map((size) => (
                ...
                >
                  ...
                  {fontSize === size && (
                    <Check className="w-5 h-5 text-[#6F91BC]" />
                  )}
                </button>
              ))}
            </div>
            ...
            <div className="px-4 pb-4">
              <div 
                ...
                style={{ backgroundColor: bgIcon }}
              >
                <p className="text-xs mb-2" style={{ color: textSecondary }}>미리보기</p>
                <p 
                  style={{ 
                    color: textPrimary,
